  ...
  useEffect(() => {
    ...
    if (error) {
      const errorMessages: Record<string, string> = {
        ...
        'user_check_failed': 'Failed to check user account',
        'user_creation_failed': 'Failed to create user account',
        'role_assignment_failed': 'Failed to assign user role',
        'password_set_failed': 'Failed to set user password',
        ...
        'no_session': 'No authentication session found',
        'no_user': 'No user data available',
    ...
    } else if (message === 'google_account_ready' && email) {
            ...
            <CardContent>
              ...
              <Button 
                ...
                onClick={async () => {
                  ...
                  console.log('Login page: Starting Google OAuth flow...')
                  ...
                  if (result.error) {
                    ...
                    console.log('Login page: Google OAuth initiated, redirecting...')
                  }
                }}
              >
                {isGoogleLoading ? (
              ...
              {user && (
                <div className="text-center text-sm text-muted-foreground mt-4">
                  ...
                  >
                    Sign out to test Google OAuth again
                  </Button>
                </div>
              )}
            </CardContent>
